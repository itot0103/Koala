...
public class Transformer {
	static int VIEWING_SCALE = 1;
	static int VIEWING_SHIFT = 2;
	static int VIEWING_ROTATE = 3;
	...
	public void drag(int x, int y, int width, int height, int dragMode) {
		...
		if (dragMode == VIEWING_SCALE) { // ZOOM
		...
		if (dragMode == VIEWING_SHIFT) { // SHIFT
			/*
		...
		if (dragMode == VIEWING_ROTATE) { // ROTATE
	...
	public void setDefaultValue() {
		...
		tableMin[0] = tableMin[1] = tableMin[2] = 0.0;
		tableMax[0] = tableMax[1] = tableMax[2] = 1.0;
